<div id="banner">
            ...
            <map name="Map" id="Map">
              ...
              <area shape="rect" coords="-5,7,23,37" href="#" title="Facebook" /><area shape="rect" coords="40,1,68,34" href="https://twitter.com/DocsMobile" target="_blank" alt="" title="Twitter" /></map>
                ...
                <div id="menu-content">
                 <div id="menu">
                   <ul>
                     <li><a href="index.php" title="Home"class="activate" >Home</a></li>
                     <li><a href="beforeafter.php" title="Before & After" >Before & After</a></li>
                     <li style="border:none"><a href="contactus.php" title="Contact us">Contact us</a></li>
